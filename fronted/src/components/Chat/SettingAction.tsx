      ...
      <Switch>
        <Match when={actionState.showSetting === "global"}>
          <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
            ...
            <SettingItem icon="i-carbon:list" label="Voice">
              <select name="Voice" id="Voice"
                class="input-box"
                value={store.globalSettings.Voice}
                onchange={e => {
                  setStore(
                    "globalSettings",
                    "Voice",
              ...
              >
                ...
                <option value="zh-CN-XiaochenMultilingualNeural">晓辰 - 多语言</option>
                <option value="zh-CN-YunyiMultilingualNeural">云逸 - 多语言</option>
                <option value="en-US-AvaMultilingualNeural">Ava - 美式英语</option>
                <option value="en-US-AndrewMultilingualNeural">Andrew - 美式英语</option>
                <option value="en-US-EmmaMultilingualNeural">Emma - 美式英语</option>
                <option value="en-US-BrianMultilingualNeural">Brian - 美式英语</option>
              </select>
              {/* <select
                type="password"
                value={store.globalSettings.APIKey}
